...
export class Excel {
  constructor() {
     ...
     * @type { Array<number> }
     */
    this.cWidthPrefixSum = []; // Prefix sum for column widths
    /**
     * @type { Array<number> }
     */
    this.rHeightPrefixSum = []; // Prefix sum for row heights
  ...
  init() {
    ...
    this.rHeightPrefixSum.push(0)
    this.cWidthPrefixSum.push(0)
  }
