...
export class GraphUtils {
  constructor(excel) {
     ...
     * @type {HTMLElement}
     */
    this.cancelBtn = document.getElementById("cancelContainer");
     ...
     * @type {HTMLElement}
     */
    this.fileUpload = document.querySelector(".custom-file");

    /**
     * @type {HTMLElement}
     */
    this.getData = document.getElementById("getData");
  ...
  init() {
    ...
    this.addClickListener(this.getData, () => {
      this.grid.fetchData(0, 100);
    });

    this.addClickListener(this.fileUpload, () => {
      this.setDisplay(this.uploadContainer, "inline-block");
    });

    this.addClickListener(this.cancelBtn, () => {
      this.setDisplay(this.uploadContainer, "none");
    });
