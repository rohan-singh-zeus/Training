...
export class Scroll {
  ...
  init() {
    ...
    this.containerHeight =
      this.excel.rHeightPrefixSum[
        this.excel.rHeightPrefixSum.length - 1
      ];
    this.containerWidth =
 ...
 updateVerticalScroll(percentage) {
  this.excel.shiftTopY = Math.abs((percentage * (this.containerHeight - this.mainGrid.canvas.height)) / 100);
  this.excel.shiftBottomY = this.excel.shiftTopY + this.mainGrid.canvas.height;
  ...
  console.log(this.containerHeight, this.mainGrid.canvas.height, this.excel.shiftTopY, this.excel.shiftBottomY, this.excel.topIndex, this.excel.bottomIndex);
