...
function toggleClassName(itemCall, classToggle) {
    ...
    console.log(item);
    item === null || item === void 0 ? void 0 : item.classList.toggle(classToggle);
}
...
function populateCards(d) {
    ...
    cc5.className = "cc-5";
    cc5.innerText = `
           ${d.info.totalStudents && d.info.totalStudents} students  |  ${d.info.duration && d.info.duration}
        `;
    ...
    ele1 === null || ele1 === void 0 ? void 0 : ele1.appendChild(card);
}
function populateAnnouncements(d) {
    ...
    ele2 === null || ele2 === void 0 ? void 0 : ele2.appendChild(ashish);
}
function populateNotifications(d) {
    ...
    ele3 === null || ele3 === void 0 ? void 0 : ele3.appendChild(ashish);
}
